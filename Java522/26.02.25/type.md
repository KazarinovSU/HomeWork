...
```
___
### 2. Переменные по области видимости
...
```
___
+ **3. Переменные по времени жизни** Переменные могут быть также классифицированы в зависимости от их времени жизни, которое зависит от их области видимости.
  ...
  ___
 + **4. Константы** Константы — это переменные, значения которых не могут быть изменены после инициализации. В Java константы обычно создаются с помощью ключевого слова `final`.
...
```
___
+ **Переменные типа `var` (для автоматического вывода типа)** С версии Java 10 появился тип `var`, который позволяет компилятору автоматически выводить тип переменной на основе присваиваемого значения.
